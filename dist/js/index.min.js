...
const burger=()=>{const e=$(".burg-btn"),n=$(".burger-menu");e.on("click",(function(){n.fadeToggle(500)})),$(document).mouseup((function(t){var o=$(t.target);0==o.closest(n).length&&0==o.closest(e).length&&n.hide()}))};burger();
const form=()=>{const t=$(".form__subtitle");$(".form-field__input-num").focus((()=>{t.text("Введите ваш телефон")})),$(".form-field__input-mail").focus((()=>{t.text("Введите ваш e-mail")})),$(".form__inp").blur((()=>{t.text("Заполните форму")})),$(".form__form-input").submit((function(e){e.preventDefault(),$.ajax({url:"https://jsonplaceholder.typicode.com/todos",type:"POST",data:$(this).serialize(),success(e){t.text("Спасибо ваша заявка принята, номер заявки "+e.id)},error(){t.text("Что то пошло не так, попробуйте позже!")}})}))};form();
const sara=()=>{const t=$(".sara__button"),o=$(".sara__modal-knopa"),n=$(".modal-order"),e=$(".sara__subtitle"),i=$(".help__btn-modal");t.on("click",(function(){n.show(500)})),i.on("click",(function(){n.show(500)})),n.click((function(t){0==$(t.target).closest(".form-modal").length&&$(this).fadeOut()})),o.on("click",(function(){n.hide(500)})),$(".form-field__input-number").focus((function(){e.text("Введите ваш телефон")})),$(".form-field__input-email").focus((function(){e.text("Введите ваш e-mail")})),$(".form-field__input").blur((function(){e.text("Заполните форму")})),$(".sara__form-input").submit((function(t){t.preventDefault(),$.ajax({url:"https://jsonplaceholder.typicode.com/todos",type:"POST",data:$(this).serialize(),success(t){e.text("Спасибо ваша заявка принята, номер заявки "+t.id)},error(){e.text("Что то пошло не так, попробуйте позже!")}})}))};sara();