...
"use strict";var burger=function(){var e=$(".burg-btn"),n=$(".burger-menu");e.on("click",(function(){n.fadeToggle(500)})),$(".burger__link").on("click",(function(){n.hide()})),$(document).mouseup((function(r){var t=$(r.target);0==t.closest(n).length&&0==t.closest(e).length&&n.hide()}))};burger();
"use strict";var form=function(){var o=$(".form__subtitle"),e=document.querySelector(".form__form-input");$(".form-field__input-num").focus((function(){o.text("Введите ваш телефон")})),$(".form-field__input-mail").focus((function(){o.text("Введите ваш e-mail")})),$(".form__inp").blur((function(){o.text("Заполните форму")})),$(".form__form-input").submit((function(t){t.preventDefault(),$.ajax({url:"https://jsonplaceholder.typicode.com/todos",type:"POST",data:$(this).serialize(),success:function(t){o.text("Спасибо ваша заявка принята, номер заявки "+t.id),e.reset()},error:function(){o.text("Что то пошло не так, попробуйте позже!")}})}))};form();var maps=function(){ymaps.ready((function(){var o=new ymaps.Map("map",{center:[55.849206,37.375674],zoom:12}),e=new ymaps.Placemark([55.849206,37.375674],{},{iconLayout:"default#image",iconImageHref:"img/footermaps.svg",iconImageSize:[39,59],iconImageOffset:[-33,-59]});o.geoObjects.add(e),o.behaviors.disable("scrollZoom"),o.behaviors.disable("drag"),o.controls.remove("rulerControl"),o.controls.remove("zoomControl"),o.controls.remove("fullscreenControl"),o.controls.remove("typeSelector"),o.controls.remove("trafficControl"),o.controls.remove("searchControl"),o.controls.remove("geolocationControl")}))};maps();var safari=function(){document.addEventListener("click",(function(o){o.target.matches("button")&&o.target.focus()}))};safari();var scroll=function(){var o=$("html, body");$('a[href*="#"]').click((function(){return o.animate({scrollTop:$($.attr(this,"href")).offset().top},500),!1}))};scroll();var maskOne=function(){var o=document.querySelector(".form-field__maska");new Inputmask("+7 (999)-999-99-99").mask(o)};maskOne();var maskTwo=function(){var o=document.querySelector(".form-field__mask-two");new Inputmask("+7 (999)-999-99-99").mask(o)};maskTwo();
