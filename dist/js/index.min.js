...
"use strict";var form=function(){var t=$(".form__subtitle");$(".form-field__input-num").focus((function(){t.text("Введите ваш телефон")})),$(".form-field__input-mail").focus((function(){t.text("Введите ваш e-mail")})),$(".form__inp").blur((function(){t.text("Заполните форму")})),$(".form__form-input").submit((function(i){i.preventDefault(),$.ajax({url:"https://jsonplaceholder.typicode.com/todos",type:"POST",data:$(this).serialize(),success:function(i){t.text("Спасибо ваша заявка принята, номер заявки "+i.id)},error:function(){t.text("Что то пошло не так, попробуйте позже!")}})}))};form();var swiper=function(){};swiper();
