...
"use strict";var form=function(){var t=$(".form__subtitle");$(".form-field__input-num").focus((function(){t.text("Введите ваш телефон")})),$(".form-field__input-mail").focus((function(){t.text("Введите ваш e-mail")})),$(".form__inp").blur((function(){t.text("Заполните форму")})),$(".form__form-input").submit((function(o){o.preventDefault(),$.ajax({url:"https://jsonplaceholder.typicode.com/todos",type:"POST",data:$(this).serialize(),success:function(o){t.text("Спасибо ваша заявка принята, номер заявки "+o.id)},error:function(){t.text("Что то пошло не так, попробуйте позже!")}})}))};form();
