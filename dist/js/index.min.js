...
"use strict";var form=function(){var e=$(".form__subtitle"),o=document.querySelector(".form__form-input");$(".form-field__input-num").focus((function(){e.text("Введите ваш телефон")})),$(".form-field__input-mail").focus((function(){e.text("Введите ваш e-mail")})),$(".form__inp").blur((function(){e.text("Заполните форму")})),$(".form__form-input").submit((function(t){t.preventDefault(),$.ajax({url:"https://jsonplaceholder.typicode.com/todos",type:"POST",data:$(this).serialize(),success:function(t){e.text("Спасибо ваша заявка принята, номер заявки "+t.id),o.reset()},error:function(){e.text("Что то пошло не так, попробуйте позже!")}})}))};form();var maps=function(){ymaps.ready((function(){var e=new ymaps.Map("map",{center:[55.849206,37.375674],zoom:12}),o=new ymaps.Placemark([55.849206,37.375674],{},{iconLayout:"default#image",iconImageHref:"img/footermaps.svg",iconImageSize:[39,59],iconImageOffset:[-33,-59]});e.geoObjects.add(o),e.behaviors.disable("scrollZoom"),e.behaviors.disable("drag"),e.controls.remove("rulerControl"),e.controls.remove("zoomControl"),e.controls.remove("fullscreenControl"),e.controls.remove("typeSelector"),e.controls.remove("trafficControl"),e.controls.remove("searchControl"),e.controls.remove("geolocationControl")}))};maps();var safari=function(){document.addEventListener("click",(function(e){e.target.matches("button")&&e.target.focus()}))};safari();var scroll=function(){var e=$("html, body");$('a[href*="#"]').click((function(){return e.animate({scrollTop:$($.attr(this,"href")).offset().top},500),!1}))};scroll();var maskOne=function(){var e=document.querySelector(".form-field__maska");new Inputmask("+7 (999)-999-99-99").mask(e)};maskOne();var maskTwo=function(){var e=document.querySelector(".form-field__mask-two");new Inputmask("+7 (999)-999-99-99").mask(e)};maskTwo();var pets=function(){new Swiper(".swiper",{slidePerView:1,loop:!0,navigation:{nextEl:".button-right",prevEl:".button-left"},mousewheel:!0,keyboard:!0})},reload=function(){};window.addEventListener("DOMContentLoaded",(function(){window.screen.width<=768&&pets()})),window.addEventListener("resize",(function(){window.screen.width<=768&&pets()}));
