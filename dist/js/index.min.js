...
"use strict";var burger=function(){var e=$(".burg-btn"),n=$(".burger-menu"),i=$(".header__btn-close");e.on("click",(function(){n.fadeToggle(500),window.screen.width<=480?(e.hide(),i.show()):window.screen.width>479&&(e.show(),i.hide())})),i.on("click",(function(){window.screen.width<=480&&(i.hide(),e.show())})),$(".burger__link").on("click",(function(){n.hide(),window.screen.width<=480&&(e.show(),i.hide())})),$(document).mouseup((function(i){var o=$(i.target);0==o.closest(n).length&&0==o.closest(e).length&&n.hide()}))};burger();
"use strict";var form=function(){var e=$(".form__subtitle"),t=document.querySelector(".form__form-input");$(".form-field__input-num").focus((function(){e.text("Введите ваш телефон")})),$(".form-field__input-mail").focus((function(){e.text("Введите ваш e-mail")})),$(".form__inp").blur((function(){e.text("Заполните форму")})),$(".form__form-input").submit((function(o){o.preventDefault(),$.ajax({url:"https://jsonplaceholder.typicode.com/todos",type:"POST",data:$(this).serialize(),success:function(o){e.text("Спасибо ваша заявка принята, номер заявки "+o.id),t.reset()},error:function(){e.text("Что то пошло не так, попробуйте позже!")}})}))};form();var maps=function(){ymaps.ready((function(){var e=new ymaps.Map("map",{center:[55.849206,37.375674],zoom:12}),t=new ymaps.Placemark([55.849206,37.375674],{},{iconLayout:"default#image",iconImageHref:"img/footermaps.svg",iconImageSize:[39,59],iconImageOffset:[-33,-59]});e.geoObjects.add(t),e.behaviors.disable("scrollZoom"),e.behaviors.disable("drag"),e.controls.remove("rulerControl"),e.controls.remove("zoomControl"),e.controls.remove("fullscreenControl"),e.controls.remove("typeSelector"),e.controls.remove("trafficControl"),e.controls.remove("searchControl"),e.controls.remove("geolocationControl")}))};maps();var safari=function(){document.addEventListener("click",(function(e){e.target.matches("button")&&e.target.focus()}))};safari();var scroll=function(){var e=$("html, body");$('a[href*="#"]').click((function(){return e.animate({scrollTop:$($.attr(this,"href")).offset().top},500),!1}))};scroll();var maskOne=function(){var e=document.querySelector(".form-field__maska");new Inputmask("+7 (999)-999-99-99").mask(e)};maskOne();var maskTwo=function(){var e=document.querySelector(".form-field__mask-two");new Inputmask("+7 (999)-999-99-99").mask(e)};maskTwo();var pets=function(){new Swiper(".swiper",{slidePerView:1,loop:!0,navigation:{nextEl:".button-right",prevEl:".button-left"},mousewheel:!0,keyboard:!0})};window.addEventListener("DOMContentLoaded",(function(){window.screen.width<=768&&pets()})),window.addEventListener("resize",(function(){window.screen.width<=768&&pets()}));var saraList=document.querySelector(".sara__list"),orderNum=0,saraItem=function(){var e=document.querySelectorAll(".sara__item"),t="";if(e.forEach((function(e){e.classList.contains("sara__active")&&(t=e)})),""!==t)return t},clickFull=function(e){var t=saraItem(),o=document.querySelector(".wrapper-dog"),r=e.querySelector("span").textContent,a=e.dataset.full,n=document.querySelector(".sara__title-name");void 0!==saraItem()&&(orderNum+=1,t.style.order="".concat(orderNum),t.classList.remove("sara__active")),e.classList.add("sara__active"),n.textContent=r,o.style.backgroundImage="url('".concat(a,"')")};saraList.addEventListener("click",(function(e){var t=e.target;t.closest(".sara__item")&&clickFull(t.closest(".sara__item"))}));
"use strict";var sara=function(){var t=$(".sara__button"),o=$(".sara__modal-knopa"),n=$(".modal-order"),e=$(".sara__subtitle"),i=$(".help__btn-modal"),a=document.querySelector(".sara__form-input");t.on("click",(function(){n.show(500)})),i.on("click",(function(){n.show(500)})),n.click((function(t){0==$(t.target).closest(".form-modal").length&&$(this).fadeOut()})),o.on("click",(function(){n.hide(500)})),$(".form-field__input-number").focus((function(){e.text("Введите ваш телефон")})),$(".form-field__input-email").focus((function(){e.text("Введите ваш e-mail")})),$(".form-field__input").blur((function(){e.text("Заполните форму")})),$(".sara__form-input").submit((function(t){t.preventDefault(),$.ajax({url:"https://jsonplaceholder.typicode.com/todos",type:"POST",data:$(this).serialize(),success:function(t){e.text("Спасибо ваша заявка принята, номер заявки "+t.id),a.reset()},error:function(){e.text("Что то пошло не так, попробуйте позже!")}})}))};sara();